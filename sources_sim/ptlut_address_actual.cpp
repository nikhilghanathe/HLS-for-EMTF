...
/*    const ap_uint<9> temp_th_eta [128]= init_gmt_eta;
    const ap_uint<5> temp_phi_5b [512]=init_5b_256Max;
    const ap_uint<6> temp_phi_6b [512]=init_6b_256Max;
    const ap_uint<7> temp_phi_7b [512]=init_7b_512Max;
    const ap_uint<3>  temp_get_clct[16]=clct_lut;
    const ap_uint<2>  temp_sign_lut [8]=sign_lut;*/
...
if(this->pr)cout<<"mode["<<0<<"]= "<<mode[0]<<endl;
  ...
  //            stA = 3'h0; stB = 3'h0; dA = 3'h0; dB = 3'h0; dT = 3'h0;
              ...
              if (ptlut_addr_val[i]){
                  ...
                  case 3: // two-stub tracks
                          ...
                          if(i==0){
                        	  cout<<"mode[0]= "<<mode[0]<<endl;
                        	  cout<<"bt_theta[i](6,2)= "<<bt_theta[i](6,2)<<endl;
                        	  cout<<"fr[sector[0]][bt_stB][chB] = "<<fr [sector[0]][bt_stB][chB]<<endl;
                        	  cout<<"fr [sector[0]][bt_stA][chA]=  "<<fr [sector[0]][bt_stA][chA]<<endl;
                        	  cout<<"clctB= "<<clctB<<endl;
                        	  cout<<"clctA= "<<clctA<<endl;
                        	  cout<<"get_d_th(bt_delta_th[i][dA], bt_sign_th[i][dA])= "<<get_d_th(bt_delta_th[i][dA], bt_sign_th[i][dA])<<endl;
                        	  cout<<"bt_sign_ph[i][dA] = "<<bt_sign_ph[i][dA]<<endl;
                        	  cout<<"bt_sign_th = "<<dA<<" "<<bt_sign_th[i]<<endl;
                        	  cout<<"dphi_9bits = "<<dphi_9bits<<endl;
                  ...
                  case 10: // two-stub tracks
                          ...
                          if(i==0){
                        	  cout<<"dA= "<<dA<<" get_d_th(bt_delta_th[i][dA], bt_sign_th[i][dA]) ="<<get_d_th(bt_delta_th[i][dA], bt_sign_th[i][dA])<<" bt_sign_ph[i][dA] = "<<bt_sign_ph[i][dA]<<" dphi_9bits= "<<dphi_9bits<<endl;
                          }
                      break;
      ...
      //                        chA = bt_ci[i][stA];
                              ...
                              if(this->pr){
                            	  if(i==0){
                            		  cout<<"111mode[0]= "<<mode[0]<<endl;
                            		  cout<<" bt_theta[i](6,2)= "<<bt_theta[i](6,2)<<endl;
                            		  cout<<" chA= "<<chA<<endl;
                            		  cout<<" clctA= "<<clctA<<endl;
                            		  cout<<" get_d_th(bt_delta_th[i][dT], bt_sign_th[i][dT]),= "<<get_d_th(bt_delta_th[i][dT], bt_sign_th[i][dT])<<endl;
                            		  cout<<" clctA= "<<clctA<<endl;
                            		  cout<<" clctA= "<<clctA<<endl;
                            		  cout<<" clctA= "<<clctA<<endl;
      ...
      //                        chA = bt_ci[i][stA];
                              ...
                              dphi_7bits = bt_delta_ph[i][dA] > 511 ? ap_uint<9>(511) : ap_uint<9>(bt_delta_ph[i][dA]);
                              if(i==0){
                            	  cout<<"dphi7bits= "<<dphi_7bits<<endl;
                            	  cout<<"dphi5bits= "<<dphi_5bits<<endl;
                            	  cout<<"bt_cpattern[i][0]"<<bt_cpattern[i][0]<<endl;
                              }
                              // compress delta phi
                              switch(i){
                              case 0: dphiA = phi_7b_0[dphi_7bits]; dphiB = phi_5b_0[dphi_5bits]; break;
                              ...
                              if(i==0){
                            	  ...
                            	  cout<<"dphi5bits= "<<dphi_5bits<<endl;
                            	  cout<<"bt_cpattern[i][0]"<<bt_cpattern[i][0]<<endl;
                            	  cout<<"dA = "<<dA<<" dB = "<<dB<<" dT = "<<dT<<" bt_stA = "<<bt_stA<<" chA = "<<chA<<endl;
                            	  for(int j=0;j<6;j++)
                            		  cout<<"bt_delta_ph[0]["<<j<<"]= "<<bt_delta_ph[0][j]<<endl;
                              }
                              ptlut_addr[i] =
                              (
                                  mode[i],
                              ...
                              if(i==0){
                        	  cout<<"bt_theta= "<<bt_theta[i]<<endl;
                        	  cout<<"fr [sector[0]][bt_stA][chA]= "<<fr [sector[0]][bt_stA][chA]<<endl;
                        	  cout<<"clctA"<<clctA<<endl;
                        	  cout<<"get_d_th(bt_delta_th[i][dT], bt_sign_th[i][dT])= "<<get_d_th(bt_delta_th[i][dT], bt_sign_th[i][dT])<<endl;
                        	  cout<<"bt_sign_ph[i]= "<<bt_sign_ph[i]<<endl;
                        	  cout<<"dphiB= "<<dphiB<<endl;
                        	  cout<<"dphiA= "<<dphiA<<endl;
                        	 // cout<<"dphi5bits= "<<dphi_5bits<<endl;
                              }
                              cout<<"check1"<<endl;
                          break;
      ...
      //                        chA = bt_ci[i][stA];
                      ...
                      case 14: // 2-3-4 special case
                          ...
                          if(i==0){
cout<<"concat = "<<dec<<ptlut_addr[i](3,0)<<" "<<ptlut_addr[i](7,4)<<" "<<ptlut_addr[i](11,8)<<" "<<ptlut_addr[i](15,12)<<" "<<ptlut_addr[i](19,16)<<" "<<ptlut_addr[i](23,20)<<" "<<ptlut_addr[i](27,24)<<" "<<ptlut_addr[i](29,28)<<endl;
                        	  cout<<"bt_theta[0]= "<<bt_theta[i]<<endl;
                        	  cout<<"mode[0]= "<<mode[0]<<endl;
                        	  cout<<"bt_theta[i](6,2)= "<<bt_theta[i](6,2)<<endl;
                        	  cout<<"clctA= "<<clctA<<endl;
                        	  cout<<" get_d_th(bt_delta_th[i][4], bt_sign_th[i][4])=  "<< get_d_th(bt_delta_th[i][4], bt_sign_th[i][4])<<endl;
                        	  cout<<"bt_sign_ph[i][5]= "<<bt_sign_ph[i][5]<<endl;
                        	  cout<<"bt_sign_ph[i][3]= "<<bt_sign_ph[i][3]<<endl;
                        	  cout<<"dphiC= "<<dphiC<<endl;
                        	  cout<<"dphiA = "<<dphiA<<endl;
                        	//  cout<<"dphi_9bits = "<<dphi_9bits<<endl;
  ...
  //                        chA = bt_ci[i][stA];
                          ...
                          if(i==0){
cout<<"concat = "<<hex<<ptlut_addr[i](3,0)<<" "<<ptlut_addr[i](7,4)<<" "<<ptlut_addr[i](11,8)<<" "<<ptlut_addr[i](15,12)<<" "<<ptlut_addr[i](19,16)<<" "<<ptlut_addr[i](23,20)<<" "<<ptlut_addr[i](27,24)<<" "<<ptlut_addr[i](29,28)<<endl;
cout<<"bt_theta[i]= "<<bt_theta[i]<<endl;
cout<<"bt_delta_ph[3]= "<<bt_delta_ph[i][3]<<endl;
cout<<"bt_delta_ph[5]= "<<bt_delta_ph[i][5]<<endl;
cout<<"bt_delta_ph[0]= "<<bt_delta_ph[i][0]<<endl;
cout<<"dphi_5bits= "<<dphi_5bits<<endl;
cout<<"dphi_6bits= "<<dphi_6bits<<endl;
cout<<"dphi_7bits= "<<dphi_7bits<<endl;
                        	  cout<<"bt_theta[0]= "<<bt_theta[i]<<endl;
                        	  cout<<"mode[0]= "<<mode[0]<<endl;
                        	  cout<<"bt_theta[i](6,2)= "<<bt_theta[i](6,2)<<endl;
                        	  cout<<"fr [sector[0]][bt_stA][chA]= "<<fr [sector[0]][bt_stA][chA]<<endl;
                        	  cout<<" sign34=  "<< sign34<<endl;
                        	  cout<<"sign23= "<<sign23<<endl;
                        	  cout<<"dphiC= "<<dphiC<<endl;
                        	  cout<<"dphiB= "<<dphiB<<endl;
                        	  cout<<"dphiA = "<<dphiA<<endl;
                        	//  cout<<"dphi_9bits = "<<dphi_9bits<<endl;
