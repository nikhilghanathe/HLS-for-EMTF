...
//			    	cout<<hex<<"ph_zone_bnd1= "<<ph_zone_bnd1<<endl;
//			    }
...
//				}
		...
		if(station==2 && cscid==0){
		//	cout<<"primconv th[0]="<<th[0]<<" th[1]="<<th[1]<<endl;
		//	cout<<"th_tmp="<<th_tmp<<endl;
		}
