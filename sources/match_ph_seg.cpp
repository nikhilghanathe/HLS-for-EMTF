...
void sp_c::match_ph_seg(
		   // numbers of best ranks [zone][rank number]
			...
			ap_uint<6> 		ph_qr [4][3])
{
#pragma HLS ARRAY_RESHAPE variable=si complete dim=1
#pragma HLS INTERFACE ap_ctrl_none port=return
#pragma HLS INLINE off
#pragma HLS PIPELINE II=1
#pragma HL PROTOCOL fixed
...
#pragma HLS UNROLL
	...
	fs_00[ki].find_segment_st1_7_4(ph_num[0][ki],ph_q[0][ki],
					...
					&vi[0][ki][0], &hi[0][ki][0],
					&ci[0][ki][0], &a_si[0][ki][0], &ph_match[0][ki][0],
	...
	fs_01[ki].find_segment_stn1_4_2(ph_num[0][ki],ph_q[0][ki],
					...
					&vi[0][ki][1], &hi[0][ki][1],
					&ci[0][ki][1], &a_si[0][ki][1], &ph_match[0][ki][1],
	...
	fs_02[ki].find_segment_stn1_4_2(ph_num[0][ki],ph_q[0][ki],
					...
					&vi[0][ki][2], &hi[0][ki][2],
					&ci[0][ki][2], &a_si[0][ki][2], &ph_match[0][ki][2],
	...
	fs_03[ki].find_segment_stn1_4_2(ph_num[0][ki],ph_q[0][ki],
					...
					&vi[0][ki][3], &hi[0][ki][3],
					&ci[0][ki][3], &a_si[0][ki][3], &ph_match[0][ki][3],
	...
	fs_10[ki].find_segment_st1_7_4(ph_num[1][ki],ph_q[1][ki],
					...
					&vi[1][ki][0], &hi[1][ki][0],
					&ci[1][ki][0], &a_si[1][ki][0], &ph_match[1][ki][0],
	...
	fs_11[ki].find_segment_stn1_4_2(ph_num[1][ki],ph_q[1][ki],
					...
					&vi[1][ki][1], &hi[1][ki][1],
					&ci[1][ki][1], &a_si[1][ki][1], &ph_match[1][ki][1],
	...
	fs_12[ki].find_segment_stn1_7_2(ki,ph_num[1][ki],ph_q[1][ki],
					...
					&vi[1][ki][2], &hi[1][ki][2],
					&ci[1][ki][2], &a_si[1][ki][2], &ph_match[1][ki][2],
	...
	fs_13[ki].find_segment_stn1_7_2(ki,ph_num[1][ki],ph_q[1][ki],
					...
					&vi[1][ki][3], &hi[1][ki][3],
					&ci[1][ki][3], &a_si[1][ki][3], &ph_match[1][ki][3],
	...
	fs_20[ki].find_segment_st1_7_2(ki,ph_num[2][ki],ph_q[2][ki],
					...
					&vi[2][ki][0], &hi[2][ki][0],
					&ci[2][ki][0], &a_si[2][ki][0], &ph_match[2][ki][0],
...
//	std::cout<<"ph_q[2]["<<ki<<"]= "<<ph_q[2][ki]<<std::endl;
	fs_21[ki].find_segment_stn1_7_2(ki,ph_num[2][ki],ph_q[2][ki],
					...
					&vi[2][ki][1], &hi[2][ki][1],
					&ci[2][ki][1], &a_si[2][ki][1], &ph_match[2][ki][1],
	...
	fs_22[ki].find_segment_stn1_7_2(ki,ph_num[2][ki],ph_q[2][ki],
					...
					&vi[2][ki][2], &hi[2][ki][2],
					&ci[2][ki][2], &a_si[2][ki][2], &ph_match[2][ki][2],
	...
	fs_23[ki].find_segment_stn1_7_2(ki,ph_num[2][ki],ph_q[2][ki],
					...
					&vi[2][ki][3], &hi[2][ki][3],
					&ci[2][ki][3], &a_si[2][ki][3], &ph_match[2][ki][3],
	...
	fs_30[ki].find_segment_st1_7_2(ki,ph_num[3][ki],ph_q[3][ki],
					...
					&vi[3][ki][0], &hi[3][ki][0],
					&ci[3][ki][0], &a_si[3][ki][0], &ph_match[3][ki][0],
	...
	fs_31[ki].find_segment_stn1_7_2(ki,ph_num[3][ki],ph_q[3][ki],
					...
					&vi[3][ki][1], &hi[3][ki][1],
					&ci[3][ki][1], &a_si[3][ki][1], &ph_match[3][ki][1],
	...
	fs_32[ki].find_segment_stn1_7_2(ki,ph_num[3][ki],ph_q[3][ki],
					...
					&vi[3][ki][2], &hi[3][ki][2],
					&ci[3][ki][2], &a_si[3][ki][2], &ph_match[3][ki][2],
	...
	fs_33[ki].find_segment_stn1_7_2(ki,ph_num[3][ki],ph_q[3][ki],
					...
					&vi[3][ki][3], &hi[3][ki][3],
					&ci[3][ki][3], &a_si[3][ki][3], &ph_match[3][ki][3],
