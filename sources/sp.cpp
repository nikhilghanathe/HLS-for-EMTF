 ...
 void sp(	ap_uint<4>         q  [5][9][seg_ch],
	...
	//	ap_uint<12> *r_out,
		...
		//Used for Extend Sector
		 ...
		 ap_uint<bw_th>	th_match   [4][3][4][2*2zone_seg], // matching th, 2 segments
...
#pragma HLS INTERFACE ap_stable port=print_flag
#pragma HLS INTERFACE ap_stable port=sel
 	...
 	ap_uint<bw_th> 	th_match11_t [2][3][th_ch11]; // matching th for ME11 (station 0 only), 4 segments (due to th duplication)
...
#pragma HLS ARRAY_PARTITION variable=patt_ph_vi complete dim=0
#pragma HLS ARRAY_PARTITION variable=patt_ph_hi complete dim=0
#pragma HLS ARRAY_PARTITION variable=patt_ph_ci complete dim=0
#pragma HLS ARRAY_PARTITION variable=patt_ph_si complete dim=0
#pragma HLS ARRAY_PARTITION variable=ph_match_t complete dim=0
#pragma HLS ARRAY_PARTITION variable=th_match_t complete dim=0
#pragma HLS ARRAY_PARTITION variable=th_match_t1 complete dim=0
#pragma HLS ARRAY_PARTITION variable=th_match11_t complete dim=0
#pragma HLS ARRAY_PARTITION variable=cpat_match_t complete dim=0
#pragma HLS ARRAY_PARTITION variable=ph_qr_t complete dim=0
