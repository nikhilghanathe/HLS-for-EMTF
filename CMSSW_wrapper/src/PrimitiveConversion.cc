...
std::cout<<" in PrimitiveConversion.cc   tp_data.quality= "<<tp_data.quality<<" wiregroup= "<<tp_data.keywire<<std::endl;
...
void PrimitiveConversion::convert_csc_details(EMTFHit& conv_hit) const {
  ...
  std::cout<<"params[ph_ini_ix]= "<<fph<<"pc_lut_id= "<<pc_lut_id<<std::endl;
...
std::cout<<"th_tmp= "<<th_tmp<<std::endl;
